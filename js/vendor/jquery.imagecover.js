...
;(function($){
	...
	function coverImage(container, settings)
	{
		if( isActive(settings) )
		{
			resizeImage(container, settings);
		}
		else
		{
	...
	function resizeImage(container, settings)
	{
	...
	{
		container.removeAttr('style').find('img').removeAttr('style');
	};
